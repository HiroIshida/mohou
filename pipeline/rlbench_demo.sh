...
function demo_batch {
    ...
    python3 $example_path/rlbench/create_dataset_mp.py -pn $project_name -n 105 -m 4
    ...
    python3 $example_path/train_lstm.py -pn $project_name -n 10000 -image $image_type
