...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", type=int, default=40000, help="iteration number")
    parser.add_argument("-aug", type=int, default=9, help="number of augmentation X")
    parser.add_argument("-fc_layer", type=int, default=2, help="num of fc layer")
    parser.add_argument("-fc_hidden", type=int, default=400, help="num of fc hidden")
